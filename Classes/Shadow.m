...
- (BOOL)isImageRestricted:(NSString *)name {
    ...
    || [name hasPrefix:@"/usr/libexec/substitute"]
    || [name hasPrefix:@"/usr/libexec/substituted"]
    || [name hasPrefix:@"/usr/lib/libsubstitute.dylib"]
    || [name hasPrefix:@"/usr/lib/libsubstrate.dylib"]
    ...
    || [name containsString:@"substitute-loader"]
    || [name containsString:@"substitute.0"]
    || [name containsString:@"substitute-injector"]
    || [name containsString:@"substitute-inserter"]
    || [name containsString:@"Substitrate"]
    || [name containsString:@"libsubstrate"]
    || [name containsString:@"libsubstitute"]
